...
**Death triggers** — passive that fires a meaningful effect when this character dies. Heal the party on death, apply a debuff to all enemies on death, transfer current buffs to an ally. 