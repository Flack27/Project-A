...
buffs: []
debuffs: [doom, oblivion, stun, sleep]
recovery:
effects: [strip, cd reduction, turn meter-]
---
...
**Drain** — AoE active. Deal damage to all enemies. Apply [Doom] and absorb [Turn Meter-]
...
**Despoil** — AoE active. Deal damage to all enemies. Strip all buffs from all enemies. Deal bonus damage per buff removed. Apply [Stun] and [Doom] on main target.

**Singularity** — AoE active. Apply [Oblivion], [Doom] and [Sleep] to all enemies.

**Harbinger** — AoE active. Apply [Doom] to all enemies. Immediately detonate [Doom] and apply [Stun] on the main target.
...
**Decay** — [Doom] deals increased damage to a target per debuff active.
