...
Within each star tier, levels 20, 40 and 60 — the cap of tiers 2, 4 and 6 — are the major stat threshold moments where growth rate has its most visible effect. Smaller stat increases happen at every level. The threshold bumps are where two characters with different growth rates diverge most noticeably given the same investment.
